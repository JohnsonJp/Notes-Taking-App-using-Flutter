              ...
              children: [
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Welcome...,",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 50,color: (Theme.of(context).brightness == Brightness.dark) ? Colors.white70 : Colors.black),),
                      Text("Signin to Continue!,",style: TextStyle(fontWeight: FontWeight.normal,fontSize: 40,color: (Theme.of(context).brightness == Brightness.dark) ? Colors.white38 : Colors.black45)),
                    ],
                    ),
                  ),
                Expanded(
